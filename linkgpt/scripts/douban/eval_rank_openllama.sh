...
python ${PROJECT_PATH}/linkgpt/eval/eval_yn.py \
	...
	--stage 2 \
	--device cuda:0 \
	--output_path ${LINKGPT_DATA_PATH}/results/${DATASET_NAME}/${LINKGPT_MODEL_NAME}/yn_diff_score_${NUM_OF_EXAMPLES}_examples.json \
	--batch_size 4 \
	--fp16 \
	--report_to wandb \
	--wandb_key ${WANDB_KEY} \
	--wandb_project_name ${DATASET_NAME}_eval \
	--wandb_run_name ${LINKGPT_MODEL_NAME}_yn_eval_${NUM_OF_EXAMPLES}_examples
