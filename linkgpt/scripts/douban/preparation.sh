...
DATASET_NAME=douban
LINKGPT_DATA_PATH=../.. # you can change this to any other path you like to store the data
PROJECT_PATH=../..

# Calculate the PPR scores
python ${PROJECT_PATH}/pairwise_encoding/calc_ppr_scores.py \
...
python ${PROJECT_PATH}/text_graph_pretraining/graph_text_train.py \
	--dataset_name ${DATASET_NAME} \
	--dataset_for_lm_path ${LINKGPT_DATA_PATH}/datasets/${DATASET_NAME}/dataset_for_lm.pkl \
...
python ${PROJECT_PATH}/text_graph_pretraining/create_embedding.py \
	--dataset_name ${DATASET_NAME} \
	--dataset_for_lm_path ${LINKGPT_DATA_PATH}/datasets/${DATASET_NAME}/dataset_for_lm.pkl \
	--ckpt_save_path ${LINKGPT_DATA_PATH}/models/${DATASET_NAME}/cgtp_model.pt \
